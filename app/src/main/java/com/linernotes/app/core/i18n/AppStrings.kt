...
data class AppStrings(
    ...
    val cdCompanionPlay: String,
    val cdCompanionPause: String,
    val calibrateFaster: String,
    val calibrateSlower: String,
    val calibrationTip: String,
    val cdSyncTitle: String,
    val cdSyncConnected: String,
    val cdSyncConnecting: String,
    val cdSyncDisconnected: String,
    val cdSyncNotFound: String,
...
val ZhHansStrings = AppStrings(
    ...
    calibrateFaster = "+1秒",
    calibrateSlower = "-1秒",
    calibrationTip = "微调对齐实体 CD 进度",
    cdSyncTitle = "山灵 CD 同步",
    cdSyncConnected = "已连接",
    cdSyncConnecting = "正在连接...",
    cdSyncDisconnected = "未连接 CD 机",
    cdSyncNotFound = "未找到已配对的山灵 EC Mini",
...
val ZhHantStrings = AppStrings(
    ...
    calibrateFaster = "+1秒",
    calibrateSlower = "-1秒",
    calibrationTip = "微調對齊實體 CD 進度",
    cdSyncTitle = "山靈 CD 同步",
    cdSyncConnected = "已連接",
    cdSyncConnecting = "正在連接...",
    cdSyncDisconnected = "未連接 CD 機",
    cdSyncNotFound = "未找到已配對的山靈 EC Mini",
...
val EnStrings = AppStrings(
    ...
    cdCompanionPlay = "Play",
    cdCompanionPause = "Pause",
    calibrateFaster = "+1s",
    calibrateSlower = "-1s",
    calibrationTip = "Calibrate physical CD playback offset",
    cdSyncTitle = "Shanling CD Sync",
    cdSyncConnected = "Connected",
    cdSyncConnecting = "Connecting...",
    cdSyncDisconnected = "CD Player Disconnected",
    cdSyncNotFound = "No paired Shanling EC Mini found",
...
val JaStrings = AppStrings(
    ...
    cdCompanionPlay = "再生",
    cdCompanionPause = "一時停止",
    calibrateFaster = "+1秒",
    calibrateSlower = "-1秒",
    calibrationTip = "CD再生の進捗を微調整",
    cdSyncTitle = "山霊 CD 同期",
    cdSyncConnected = "接続済み",
    cdSyncConnecting = "接続中...",
    cdSyncDisconnected = "CDプレーヤー未接続",
    cdSyncNotFound = "ペアリング済みのShanling EC Miniが見つかりません",
