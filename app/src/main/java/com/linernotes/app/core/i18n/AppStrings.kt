...
val ZhHansStrings = AppStrings(
    ...
    sourceAuto = "智能双模 (优先官方双语，无译文时使用 AI)",
    sourceOfficial = "官方双语歌词 (网易云音乐，极速、人工精翻、完全对齐)",
...
val ZhHantStrings = AppStrings(
    ...
    sourceAuto = "智慧雙模 (優先官方雙語，無譯文時使用 AI)",
    sourceOfficial = "官方雙語歌詞 (網易雲音樂，極速、人工精翻、完全對齊)",
    sourceAi = "AI 自訂大模型翻譯",
...
val EnStrings = AppStrings(
    ...
    sourceAuto = "Smart Dual (Official First, fallback to AI)",
    sourceOfficial = "Official Bilingual (NetEase, Instant & Human-Translated)",
...
val JaStrings = AppStrings(
    ...
    sourceAuto = "スマートデュアル (公式対訳優先、未対応時はAI)",
    sourceOfficial = "公式バイリンガル歌詞 (NetEase 高速・人手翻訳・完全同期)",
    sourceAi = "AIモデル翻訳のみ",
