...
val ZhHantStrings = AppStrings(
    ...
    batchTranslateAlbumDesc = "後台持續並發翻譯所有曲目並實時保存",
...
val JaStrings = AppStrings(
    ...
    translateCurrentTrack = "⚡ 現在の曲を翻訳",
    batchTranslateAlbum = "💿 アルバム全体を一括翻訳",
    batchTranslateAlbumDesc = "全曲をバックグラウンドで並行翻訳しリアルタイム保存",
    batchTranslatingBanner = "バックグラウンドでアルバム全体を翻訳中",
    batchTranslateCompleted = "アルバム全体の翻訳が完了しました！",
    batchTranslateStopped = "一括翻訳をキャンセルしました",
